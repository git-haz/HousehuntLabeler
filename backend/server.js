...
app.post('/retrieve', async (req, res) => {
  try {
    ...
    const { afterDate, beforeDate, searchSubject, searchBody, searchFrom, labelsInclude, labelsExclude, unreadOnly } = req.body;
    cachedEmails = await retrieveEmails(token, { afterDate, beforeDate, searchSubject, searchBody, searchFrom, labelsInclude, labelsExclude, unreadOnly });
